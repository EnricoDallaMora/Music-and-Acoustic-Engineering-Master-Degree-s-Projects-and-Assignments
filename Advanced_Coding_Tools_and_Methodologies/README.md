Original repo at: https://github.com/albertodoimo/ACTAM
...
- By downloading the whole GitHub repository and running it using VS Code live server.
...
- An Internet connection is necessary to use the application. 
